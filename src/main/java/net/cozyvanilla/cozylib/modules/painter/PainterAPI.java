...
//
//public final class PainterAPI {
//    private static Painter instance;
//
//    private PainterAPI() {}
//
//    static void register(@NotNull Painter seasons) {
//        instance = seasons;
//    }
//
//    static void unregister(@NotNull Painter seasons) {
//        instance = null;
//    }
//
//    private static @NotNull Painter require() {
//        if (instance == null) {
