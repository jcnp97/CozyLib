package asia.virtualmc.cozylib.utilities.string;
...
public class SplitUtils {
     ...
     */
    public static String splitGet(String string, String symbol, int index) {
        if (string == null) {
            string = "";
        }
     ...
     */
    public static String splitRemove(String string, String symbol, int index) {
