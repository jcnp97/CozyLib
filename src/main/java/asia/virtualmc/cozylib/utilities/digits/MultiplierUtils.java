...
public class MultiplierUtils {
     ...
     */
    public static int ceiling(int value, double multiplier) {
     ...
     */
    public static double ceiling(double value, double multiplier) {
        double result = value * (multiplier / 100.0);
     ...
     */
    public static long ceiling(long value, double multiplier) {
        double result = value * (multiplier / 100.0);
